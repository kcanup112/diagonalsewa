...
const CompactPortfolioViewer = () => {
  ...
  // Get current media from selected portfolio
  ...
  // Navigate media within current portfolio
  ...
  }, [selectedPortfolio, currentMediaIndex, navigateMedia, toggleFullscreen]);
          ...
          >
            ...
            <div className="h-48 bg-gray-200 relative overflow-hidden">
              ...
              <div className="absolute top-3 right-3 flex space-x-1">
                {portfolio.images && portfolio.images.length > 0 && (
                  <span className="bg-blue-600 bg-opacity-90 text-white text-xs px-2 py-1 rounded-full">
                    📷 {portfolio.images.length}
                  </span>
                )}
                {portfolio.videos && portfolio.videos.length > 0 && (
                  <span className="bg-green-600 bg-opacity-90 text-white text-xs px-2 py-1 rounded-full">
                    🎥 {portfolio.videos.length}
                  </span>
                )}
                {portfolio.youtubeUrls && portfolio.youtubeUrls.length > 0 && (
                  <span className="bg-red-600 bg-opacity-90 text-white text-xs px-2 py-1 rounded-full">
                    📺 {portfolio.youtubeUrls.length}
                  </span>
                )}
              </div>
            ...
            >
              ...
              <div className={`flex ${isFullscreen ? 'h-full' : 'max-h-[70vh]'}`}>
                ...
                <div className="flex-1 bg-black relative flex items-center justify-center">
                  ...
                  {/* Navigation Arrows */}
                  {(() => {
                    const totalMedia = (selectedPortfolio.images?.length || 0) + 
                                     (selectedPortfolio.videos?.length || 0) + 
                                     (selectedPortfolio.youtubeUrls?.length || 0);
                    if (totalMedia > 1) {
                      return (
                        <>
                          <button
                ...
                {/* Project Details Sidebar - Half Screen */}
                {!isFullscreen && (
                  <div className="w-1/2 bg-white p-6 overflow-y-auto">
                    <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                          ...
                          <div>
                            ...
                            <div className="font-medium text-gray-900">{selectedPortfolio.location}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                          ...
                          <div>
                            ...
                            <div className="font-medium text-gray-900">{selectedPortfolio.area}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                          ...
                          <div>
                            ...
                            <div className="font-medium text-gray-900">{selectedPortfolio.projectType}</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="pt-4 border-t border-gray-200">
                        <h5 className="text-sm font-medium text-gray-700 mb-3">Media Summary</h5>
                        <div className="grid grid-cols-3 gap-3">
                          {selectedPortfolio.images && selectedPortfolio.images.length > 0 && (
                            <div className="text-center p-3 bg-blue-50 rounded-lg">
                              <div className="text-2xl">📷</div>
                              <div className="text-sm font-medium text-blue-700">{selectedPortfolio.images.length} Photos</div>
                            </div>
                          )}
                          {selectedPortfolio.videos && selectedPortfolio.videos.length > 0 && (
                            <div className="text-center p-3 bg-green-50 rounded-lg">
                              <div className="text-2xl">🎥</div>
                              <div className="text-sm font-medium text-green-700">{selectedPortfolio.videos.length} Videos</div>
                            </div>
                          )}
                          {selectedPortfolio.youtubeUrls && selectedPortfolio.youtubeUrls.length > 0 && (
                            <div className="text-center p-3 bg-red-50 rounded-lg">
                              <div className="text-2xl">📺</div>
                              <div className="text-sm font-medium text-red-700">{selectedPortfolio.youtubeUrls.length} YouTube</div>
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      {/* Keyboard Shortcuts */}
                      <div className="pt-4 border-t border-gray-200">
                        <h5 className="text-sm font-medium text-gray-700 mb-2">Your Service Our Satisfaction</h5>
                        <div className="text-xs text-gray-500 space-y-1">
                          <div>Your Dream House</div>
                          <div>Start Here</div>
                          <div>Contact Us</div>
                        </div>
                      </div>
...
export default CompactPortfolioViewer;

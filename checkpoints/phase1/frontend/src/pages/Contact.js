    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative text-white py-20" style={{backgroundColor: '#013b4b'}}>
        ...
        <div className="relative container-custom">
          ...
          >
            <FaEnvelope className="w-16 h-16 text-white mx-auto" />
            <h1 className="text-4xl md:text-5xl font-heading font-bold">
              Get In Touch
            </h1>
            <p className="text-xl text-gray-100 max-w-3xl mx-auto">
              Ready to start your project? We're here to help with all your construction, 
              design, and maintenance needs. Contact us today for a consultation.
            </p>
          </motion.div>
        </div>
      </section>
